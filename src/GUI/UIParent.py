...
class UIParent(customtkinter.CTkFrame):
    def __init__(self, master: any, port: str, ip: str, name: str, **kwargs):
        ...
        self.network_cl = NetworkingClient(port=self.PORT, ip=self.IP, name=self.NAME, member_list_frame=self.mlf, text_frame=self.txtfrm)
